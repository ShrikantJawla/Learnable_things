...
GET_APPLICATIONS.getData = function (filterObject) {
    $("#data-to-show").html(`<div class="loader"></div>`);
    ...
    $.ajax({
        url: "/icici/get-tele-applications-icici-ajax",
        type: "POST",
        data: REQ_DATA,
        success: function (result) {
            $("#loader").hide();
...
$("#table-filter-row").children("th").children("input").each(function () {
    ...
    $(this).change(function (e) {
        ...
        if (e.target.id === "created_at" || e.target.id === "updated_at" || e.target.id === "date_of_birth" || e.target.id === "icici_created_date") {
...
function assignValue(element) {
    ...
    $.ajax({
        url: `/users/get-telecallersInAssignment-ajax?issuer=icici`,
        type: "GET",
        success: function (result) {
            $("#loader").hide();
